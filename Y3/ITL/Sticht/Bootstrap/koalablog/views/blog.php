            ...
            <div class="col-lg-8 entries">
              ...
              <article class="entry entry-single">
                ...
                <div class="entry-meta">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog.php">blog-author-name</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog.php"><time datetime="blog-date">blog-date</time></a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog.php">0 Comments</a></li>
                  </ul>
                </div>
