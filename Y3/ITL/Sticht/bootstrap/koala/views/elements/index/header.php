<header id="header" class="fixed-top ">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <a href="index.php" class="logo"><img
        src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/160/twitter/53/koala_1f428.png" alt=""
        class="img-fluid"> Koala</a>
      ...
      <ul>
        ...
        <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Articles</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <?php
